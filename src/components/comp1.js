        ...
        <div className="my-10">
          ...
          <button className="opacity-50 hover:opacity-100 transition-all duration-300 transform hover:scale-75">
            <svg
              ...
              viewBox="0 0 32 32"
            >
              <path d="M32 2.147h-13.253l-2.747 4.733-2.747-4.733h-13.253l16 27.707zM16 18.773l-9.12-15.8h5.907l3.213 5.573 3.213-5.573h5.907z"></path>
            </svg>
          </button>
          <button className="opacity-50 hover:opacity-100 transition-all duration-300 transform hover:scale-75">
            <svg
              ...
              viewBox="0 0 32 32"
            >
              <path d="M13.24 16.86h5.512l-2.757-6.54zM15.995 0.012l-15.080 5.305 2.3 19.68 12.78 6.991 12.784-6.984 2.299-19.684zM25.405 24.408h-3.515l-1.893-4.668h-8.004l-1.893 4.668h-3.517l9.413-20.864z"></path>
            </svg>
          </button>
          <button className="opacity-50 hover:opacity-100 transition-all duration-300 transform hover:scale-75">
            <svg
