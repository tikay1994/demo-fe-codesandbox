...
function menu(props) {
  return (
    <div className="border-b py-2 mx-5 lg:mx-24">
      <nav class="flex items-center justify-between flex-wrap">
        ...
        <div className="hidden md:flex">
          <div className="ml-5">
            <button class="text-xs mr-4 text-white ">
              <ul className="group hover:opacity-100 opacity-50 mx-5">
                Features
                <div className="absolute flex text-white bg-gray-800 bg-opacity-50 dropdown mt-2">
                  <li className="hidden group-hover m-5 icon-scale">
          ...
          <div className="hidden md:block">
            <button class="text-xs text-white">
              <p className="group hover:opacity-100 opacity-50 mx-5">Pricing</p>
            </button>
          </div>
        </div>
        <div className="hidden md:flex">
